<script lang="ts">
  ...
  let descValue = $state(form?.values?.description ?? data.service.description ?? '')
  let charsLeft = $derived(125 - descValue.length)
</script>

<svelte:head>
  <title>Edit service — Snips Admin</title>
</svelte:head>
  ...
  >
    ...
    <div class="field">
      ...
      <input
        ...
        value={form?.values?.name ?? data.service.name}
        required
      />
      {#if form?.errors?.name}
    ...
    <div class="field">
      ...
      <input
        ...
        value={form?.values?.duration ?? data.service.duration_minutes}
        min="5"
        step="5"
        required
      />
    ...
    <div class="field">
      ...
      <input
        ...
        value={form?.values?.price ?? data.service.price_pounds}
        min="0"
        step="0.01"
      />
    ...
    <div class="field">
      ...
      <input
        ...
        value={form?.values?.displayOrder ?? data.service.display_order}
        min="1"
        step="1"
      />
    ...
    <div class="field field--row">
      <input
        ...
        checked={form?.values?.isActive ?? data.service.is_active}
      />

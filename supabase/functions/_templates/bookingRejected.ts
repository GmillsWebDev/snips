...
export const bookingRejected = (params: {
  shopName: string;
  customerName: string;
  serviceName: string;
  ...
  const { shopName, customerName, serviceName, appointmentDate } = params;
  return `<!DOCTYPE html>
<html lang="en">
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#1a1a1a;border-radius:12px;padding:40px;border:1px solid #2a2a2a;">
          <p style="margin:0 0 8px;font-size:13px;color:#888;text-transform:uppercase;letter-spacing:0.1em;">Booking update</p>
          <h1 style="margin:0 0 32px;font-size:22px;color:#ffffff;font-weight:600;">Sorry ${customerName}, we can't take this booking.</h1>
          ...
          <p style="margin:0;font-size:14px;color:#888;line-height:1.6;">Unfortunately we're unable to accept this booking. Please visit our booking page to choose another time.</p>
        </td></tr>
      </table>
    </td></tr>
  </table>

...
export const bookingConfirmation = (params: {
  shopName: string;
  customerName: string;
  serviceName: string;
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td align="center" style="padding-top:24px;">
          ${dashboardUrl ? `<p style="margin:0 0 8px;font-size:12px;color:#444;line-height:1.6;">Need to make changes? <a href="${dashboardUrl}" style="color:#888;text-decoration:underline;">Visit your dashboard.</a></p>` : ''}

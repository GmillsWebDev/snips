export const getSubject = ({ shopName }: { shopName: string }) =>
  `Reminder: your appointment at ${shopName} is tomorrow`;

export const bookingReminder = (params: {
  shopName: string;
  customerName: string;
  serviceName: string;
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#1a1a1a;border-radius:12px;padding:40px;border:1px solid #2a2a2a;">
          <p style="margin:0 0 8px;font-size:13px;color:#888;text-transform:uppercase;letter-spacing:0.1em;">Reminder</p>
          <h1 style="margin:0 0 32px;font-size:22px;color:#ffffff;font-weight:600;">See you tomorrow, ${customerName}.</h1>
